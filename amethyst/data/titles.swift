...
struct titles:Identifiable {
    ...
    [titles(title: "Movies", imageName: ["media","media","media","media"], genre:["Romance","Drama","Action","Fantasy"], favoriteTitles:["Someday or One Day" :"favorite", "Whisper of the Heart": "whisper"]),
     titles(title: "Shows", imageName: ["show","show","show","show"],genre:["Romance2","Drama2","Action2","Fantasy2"],favoriteTitles:["Mulan" :"mulan","Whisper of the Heart": "whisper"]),
     titles(title: "Documentaries",imageName: ["documentary","documentary","documentary","documentary"],genre:["Romance3","Drama3","Action3","Fantasy3"],favoriteTitles:["Mulan" :"mulan","Whisper of the Heart": "whisper"]),
     titles(title: "C Dramas",imageName: ["tv","tv","tv","tv"],genre:["Romance4","Drama4","Action4","Fantasy4"],favoriteTitles:["Mulan" :"mulan","Whisper of the Heart": "whisper"])]
